    ...
    <div className="min-h-screen bg-[var(--surface-alt)]">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-16 text-center animate-fade-in-up">
        <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border-light)] p-12 max-w-lg mx-auto">
          ...
          <h2 className="font-serif text-2xl text-[var(--text-primary)] mb-3">Welcome, Admin.</h2>
          <p className="text-[var(--text-secondary)]">Admin features will be added in a future update. You are logged in as <strong>{user.email}</strong>.</p>
        </div>
      </div>
    </div>
  )
